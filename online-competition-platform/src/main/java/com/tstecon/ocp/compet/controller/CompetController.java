...
//문의 글쓰기창 로그인, 로그아웃
public ModelAndView Compet_qna_login(@ModelAttribute("member")CompetQnaVO competqnaVO, RedirectAttributes rAttr,  HttpServletRequest request, HttpServletResponse response) throws Exception;
