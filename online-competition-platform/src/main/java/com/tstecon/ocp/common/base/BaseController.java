package com.tstecon.ocp.common.base;
...
public abstract class BaseController {
	...
	// 나중에 수정
//	protected List<ImageFileVO> upload(MultipartHttpServletRequest multipartRequest) throws Exception { List<ImageFileVO> fileList = new ArrayList<ImageFileVO>();
