...
public class FileDownloadController {
	...
	protected void competFile_download(@RequestParam("compet_file_name") String compet_file_name,
	...
	protected void competNoticeFile_download(@RequestParam("compet_notice_file_name") String compet_notice_file_name,
	...
	protected void mainNoticeFile_download(@RequestParam("main_notice_file_name") String main_notice_file_name,
	...
	protected void memberFile_download(@RequestParam("member_file_name") String member_file_name,
