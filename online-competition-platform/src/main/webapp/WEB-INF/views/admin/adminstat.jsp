									...
									<div class="row">
										...
										<div class="col-sm-12 col-md-6">
											...
											<div class="general-button">
									            <button type="button" class="btn mb-2 btn-exel">엑셀출력</button>
												<div class="general-button">
									...
									<div class="row">
										<div class="col-sm-12">
                                            ...
                                            <c:if test="${adminAllList !=null }">
                                                <c:forEach var="admin_StatList" items="${adminAllList}" varStatus="adminNum">
                                                    <tr align="center">
                                                        <td width="5%"></td>
                                                        <td width="15%">${admin_StatList.ctg_name}</td>
                                                        <td width="20%">${admin_StatList.compet_name }</td>
                                                        <td width="20%">${admin_StatList.contents_name}</td>
                                                        <td width="10%">${admin_StatList.mem_nickname}</td>
                                                        <td width="15%">${admin_StatList.contents_processing_date}</td>
                                                        <td width="12%">${admin_StatList.contents_view}</td>
                                                        <td width="15%">${admin_StatList.likes1}</td>
                                                        <td width="15%">${admin_StatList.cmt1}</td>
                                                    </tr>
                                                </c:forEach>
                                            </c:if>
