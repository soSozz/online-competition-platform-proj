...
<script
	src="${contextPath}/resources/plugins/tables/js/jquery.dataTables.min.js"></script>
<script
	src="${contextPath}/resources/plugins/tables/js/datatable/dataTables.bootstrap4.min.js"></script>
<script
	src="${contextPath}/resources/plugins/tables/js/datatable-init/datatable-basic.min.js"></script>
		...
		<div class="card">
			<div class="card-body">
				...
				<div class="table-responsive">
										...
										<td width="25%" align="left" style="padding-left: 30px">
											<c:choose>
												<c:when test="${qna.level > 1 }">
													...
													<a class="cls1"
														href="${contextPath}/qna/qnaDetail.do?articleNO=${qna.compet_qna_id}">${qna.compet_qna_title}</a>
												</c:when>
					...
					<!-- 문의 게시판 하단 -->
					<div class="qna_write" style="float: right; margin: 10px;">
						<button type="button" class="btn btn-outline-secondary"
							onClick="fn_articleForm('${loginStatus}')">글쓰기</button>
					</div>
