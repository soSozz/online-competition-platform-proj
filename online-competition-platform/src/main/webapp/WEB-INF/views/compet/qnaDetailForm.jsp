        ...
        <form 
          ...
          style="width: 50%; position: relative; left: 23%; margin: 40px;" >
             ...
             <div class="form-group"  style="width:30%; height:50px ; "  >
                <input type="text" size="20" class="form-control bg-transparent" name="articleNO" value="${article.compet_qna_id }" placeholder="글번호">
             </div> 
             
              <div  style="width:30%;  position: relative; left: 33%; bottom: 70px;">
                <div class="form-group"  >
                  <input type="text" class="form-control bg-transparent" name="date" value="${article.compet_qna_date }" placeholder="등록일자">
                </div>
              </div>   
            ...
            <div class="form-group" >
                <input type="text" class="form-control bg-transparent" name="title"   value="${article.compet_qna_title }" placeholder=" 글제목">
            </div>
            <div class="form-group">
                <textarea class="textarea_editor form-control bg-light" rows="15" name="content"  value="${article.compet_qna_text }"placeholder="글내용"></textarea>
            </div>
