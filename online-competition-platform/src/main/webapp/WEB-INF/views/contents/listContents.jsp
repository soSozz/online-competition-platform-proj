						...
						<c:choose>
							<c:when test="${listContents == null} ">
								<tr height="10">
									<td colspan="5">
										<p align="center">
											<b><span style="font-size: 9pt">등록된 컨텐츠가 없습니다.</span></b>
										</p>
									</td>
								</tr>
							</c:when>
								...
								<tbody>
									<c:forEach var="listContents" items="${listContents}"
										...
										<tr>
											<td>${status.count}</td>
											<td><a
												href="${contextPath}/contents/contentsView.do?contents_id=${listContents.contents_id}">${listContents.contents_name}</a></td>
